...
import UserFieldsExistenceCheck from '../middlewares/UserFieldsExistenceCheck';
...
routes.post('/', UserFieldsExistenceCheck, (req, res, next) => userControllers.create(req, res, next));
...
routes.put('/:id', UserFieldsExistenceCheck, (req, res, next) => userControllers.update(req, res, next));
